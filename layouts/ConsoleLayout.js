                  ...
                  <NavList className="nav-group is-expanded">
                    <div className="group-header">
                      <NavHeader className="group-header-label">
                        <Label1>{capitalize(fireUser?.data?.role) || "Store"}</Label1>
                      </NavHeader>
                      <div>
                        <ActiveConsoleLink blackList={[]} name="homeFilled" href={"/[adminID]/overview"} as={`/${user?.uid}/overview`}>
                          Overview
                        </ActiveConsoleLink>
                        <ActiveConsoleLink name="ordersFilled" href={"/[adminID]/orders/[filter]"} as={`/${user?.uid}/orders/active`}>
                          Orders
                        </ActiveConsoleLink>
                        <ActiveConsoleLink
                          blackList={["driver"]}
                        ...
                        <ActiveConsoleLink
                          blackList={["driver"]}
                          name="barcode"
                          href={"/[adminID]/products"}
                          as={`/${user?.uid}/products`}
                        >
                          Products
                        </ActiveConsoleLink>
                        <ActiveConsoleLink
                          ...
                          href={"/[adminID]/collections"}
                          as={`/${user?.uid}/collections`}
                        >
                          Collections
                        </ActiveConsoleLink>
                        <ActiveConsoleLink
                        ...
                        <ActiveConsoleLink
                          blackList={["driver"]}
                          name="couponsFilled"
                          href={"/[adminID]/discounts"}
                          as={`/${user?.uid}/discounts`}
                        >
                          Discounts
                        </ActiveConsoleLink>
                        <ActiveConsoleLink
                          blackList={["driver", "customer"]}
                          name="gearFilled"
                        ...
                        <ActiveConsoleLink blackList={[]} name="moneyFilled" href={"/[adminID]/finance"} as={`/${user?.uid}/finance`}>
                          Finance
                        </ActiveConsoleLink>
                      </div>
                    </div>
