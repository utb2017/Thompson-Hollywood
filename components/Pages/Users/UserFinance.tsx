...
const Finances = (props) => {
  ...
  const {fireTotals, fireTotalsUnsettled, fireCustomer} = useUser()
  ...
  useEffect(() => {
    ...
    if (form?.value === 'today') {
      ...
      setTotalsSubCollection(["users", `${fireCustomer.data.id}`, "Totals"])
      setTotalsDoc("active");
      ...
      setOrderBy('id')
      setWhere([['dateFormat', '==', `${formatted_date}`],['settled', '==', false],['progress', '==', 'paid']])
      setQuerySubCollection(["users", `${fireCustomer.data.id}`, 'Orders'])
    //   setRef(
    //     firebase
    //     .firestore()
    //     .collection("users")
    ...
    // )
        ...
        setTotalsSubCollection(["users", `${fireCustomer.data.id}`, "History"])
    ...
    // )
      ...
      setOrderBy('id')
      setWhere([['dateFormat', '==', `${y_formatted_date}`],['settled', '==', true],['progress', '==', 'paid']])
      setQuerySubCollection(["users", `${fireCustomer.data.id}`, 'Orders'])
    ...
    setOrderBy('id')
    setWhere([['week', '==', +date_data.week],['year', '==', +date_data.year],['settled', '==', true],['progress', '==', 'paid']])
    setQuerySubCollection(["users", `${fireCustomer.data.id}`, 'Orders'])
    ...
    setOrderBy('id')
    setWhere([['week', '==', +(date_data.week === 1) ? 144 : (date_data.week - 1)],['year', '==', +date_data.year],['settled', '==', true],['progress', '==', 'paid']])
    setQuerySubCollection(["users", `${fireCustomer.data.id}`, 'Orders'])
    ...
    setOrderBy('id')
    setWhere([['year', '==', +year],['month', '==', +month],['settled', '==', true],['progress', '==', 'paid']])
    setQuerySubCollection(["users", `${fireCustomer.data.id}`, 'Orders'])
    ...
    setOrderBy('id')
    setWhere([['year', '==', +year],['month', '==', +(month === 0 ? 11: month-1)],['settled', '==', true],['progress', '==', 'paid']])
    setQuerySubCollection(["users", `${fireCustomer.data.id}`, 'Orders'])
    ...
    //     //.where('month', '==', y_month)
    // )
       // alert(fireCustomer?.data?.id)
    setOrderBy('id')
    setWhere([['year', '==', +year],['settled', '==', true],['progress', '==', 'paid']])
    setQuerySubCollection(["users", `${fireCustomer.data.id}`, 'Orders'])
    ...
    // )
      setOrderBy('id')
      setWhere([['year', '==', +(year-1)],['settled', '==', true],['progress', '==', 'paid']])
      setQuerySubCollection(["users", `${fireCustomer.data.id}`, 'Orders'])
    ...
    // )
      setOrderBy('id')
      setWhere([['settled', '==', true],['progress', '==', 'paid']])
      setQuerySubCollection(["users", `${fireCustomer.data.id}`, 'Orders'])
    }
    return () => {
      setTotalsField(null)
