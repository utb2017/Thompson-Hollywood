  ...
  return (
    ...
    <CustomTable>
      <StyledHead $width="100%">
        ...
        <StyledHeadCell style={{ flex: 3 }}>Info</StyledHeadCell>
        {/* {!isMobile && <StyledHeadCell style={{ flex: 2 }}>Schedule</StyledHeadCell>} */}
        {!isMobile && <StyledHeadCell style={{ flex: 1 }}>Driver</StyledHeadCell>}
        {/* {!isMobile && <StyledHeadCell style={{ flex: 1 }}>Items</StyledHeadCell>} */}
        {<StyledHeadCell style={{ flex: 2 }}>Progress</StyledHeadCell>}
        {router?.query?.filter !== 'paid' && <StyledHeadCell style={{ flex: 2 }}>Action</StyledHeadCell>}
