...
const DisplayName = () => {
  ...
  const defaultForm = new DisplayNameClass(
    fireUser?.data?.displayName, // displayName:string,
  );
  ...
  return (
    <>
      ...
      <ModalFooter>
        ...
        <ModalButton disabled={fireUser?.data?.displayName === form?.displayName || !form?.displayName?.length } isLoading={loading} onClick={handleClick}>
          Save
        </ModalButton>
      </ModalFooter>
    </>
