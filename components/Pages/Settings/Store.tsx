      ...
      > */}
                ...
                >
                    ...
                    >
                        ...
                        <FlexGridItem {...dayLabelCol}><Paragraph2>{fireSettings?.data?.sunday ? `${fireSettings?.data?.sunday.open.label}-${fireSettings?.data?.sunday.close.label}`.replace(/\s/g,'') : 'Closed'}</Paragraph2></FlexGridItem>
                        <FlexGridItem {...dayCol}><Label3>Monday</Label3></FlexGridItem>
                        <FlexGridItem {...dayLabelCol}><Paragraph2>{fireSettings?.data?.monday ? `${fireSettings?.data?.monday.open.label}-${fireSettings?.data?.monday.close.label}`.replace(/\s/g,'') : 'Closed'}</Paragraph2></FlexGridItem>
                        <FlexGridItem {...dayCol}><Label3>Tuesday</Label3></FlexGridItem>
                        <FlexGridItem {...dayLabelCol}><Paragraph2>{fireSettings?.data?.tuesday ? `${fireSettings?.data?.tuesday.open.label}-${fireSettings?.data?.tuesday.close.label}`.replace(/\s/g,'') : 'Closed'}</Paragraph2></FlexGridItem>
                        <FlexGridItem {...dayCol}><Label3>Wednesday</Label3></FlexGridItem>
                        <FlexGridItem {...dayLabelCol}><Paragraph2>{fireSettings?.data?.wednesday ? `${fireSettings?.data?.wednesday.open.label}-${fireSettings?.data?.wednesday.close.label}`.replace(/\s/g,'') : 'Closed'}</Paragraph2></FlexGridItem>
                        <FlexGridItem {...dayCol}><Label3>Thursday</Label3></FlexGridItem>
                        <FlexGridItem {...dayLabelCol}><Paragraph2>{fireSettings?.data?.thursday ? `${fireSettings?.data?.thursday.open.label}-${fireSettings?.data?.thursday.close.label}`.replace(/\s/g,'') : 'Closed'}</Paragraph2></FlexGridItem>
                        <FlexGridItem {...dayCol}><Label3>Friday</Label3></FlexGridItem>
                        <FlexGridItem {...dayLabelCol}><Paragraph2>{fireSettings?.data?.friday ? `${fireSettings?.data?.friday.open.label}-${fireSettings?.data?.friday.close.label}`.replace(/\s/g,'') : 'Closed'}</Paragraph2></FlexGridItem>
                        <FlexGridItem {...dayCol}><Label3>Saturday</Label3></FlexGridItem>
                        <FlexGridItem {...dayLabelCol}><Paragraph2>{fireSettings?.data?.saturday ? `${fireSettings?.data?.saturday.open.label}-${fireSettings?.data?.saturday.close.label}`.replace(/\s/g,'') : 'Closed'}</Paragraph2></FlexGridItem>
