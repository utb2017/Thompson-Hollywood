...
class ScrollTrack extends Component {
  ...
  renderRightArrow = () => {
    ...
    return (
      ...
      >
        {nextButtonContent || <SVGIcon  name="arrowRightSmall" />}
      </CircleButton>
    )
  }
  ...
  renderLeftArrow = () => {
    ...
    return (
      ...
      >
        {backButtonContent || <SVGIcon name="arrowLeftSmall" />}
      </CircleButton>
    )
  }

  render() {
    const { containerStyles, innerContainerStyles, collapsed } = componentStyles
    const {
      children,
      scrollSpeed,
 ...
 const ScrollTrackWidth = (props) => {
  const { width } = useWindowSize()
  return(
    <ScrollTrack {...{width}} {...props}/>
  )
}
export default ScrollTrackWidth